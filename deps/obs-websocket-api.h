...
// Vendored verbatim from https://github.com/obsproject/obs-websocket (lib/obs-websocket-api.h).
// Formatting is disabled so the file can be refreshed from upstream as-is.
// clang-format off
